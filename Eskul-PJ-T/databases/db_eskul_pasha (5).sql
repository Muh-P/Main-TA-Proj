...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 09:16 PM
...
(5, 'Jane', 'Belum diatur', 'Belum diatur', 'Belum diatur', 5);
...
(3, 'endro ahmad', 'Belum diatur', 'Belum diatur', 6);
...
(5, 's_jane', '$2y$10$Sh7gN3.bgwjpl0FMhW9jROII7BZWuWrFI9zcC2Un/xB70pNhACe3y', 'Jane', 'student', 'fotos/profile/default.png'),
(6, 't_endro', '$2y$10$UpchKJ2y3XTVFi2sT/CuJ.mY9dHaSaiyiEvd/nVLOvPf9K.ly8HsK', 'endro ahmad', 'teacher', 'fotos/profile/default.png');
...
--
ALTER TABLE `eskul`
  MODIFY `eskul_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

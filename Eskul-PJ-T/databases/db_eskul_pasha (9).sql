...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 12:51 AM
...
INSERT INTO `eskul_students` (`id`, `eskul_id`, `student_id`) VALUES
(4, 4, 12),
(5, 5, 12);
...
INSERT INTO `prestasi` (`prestasi_id`, `student_id`, `eskul_id`, `judul_prestasi`, `tingkat`, `poin`, `tanggal`, `id_semester`, `created_at`) VALUES
(1, 12, 4, 'Prestasi', 'Sekolah', 1, '2025-05-02', 1, '2025-05-01 22:20:42'),
(5, 12, 4, 'Prestasi', 'Sekolah', 1, '2025-05-02', 1, '2025-05-01 22:23:12');
...
(12, 'jane', 'jane@email.com', '111', 13, 1);
...
(4, 'mimi', 'Belum diatur', 'Belum diatur', 14);
...
(13, 's_jane', '$2y$10$fFGadZNWC2eNovRXLH0cJe.6TwVGgdy48h5.7Pldr775qy2nQP9qu', 'jane', 'student', 'fotos/profile/default.png'),
(14, 't_mimi', '$2y$10$Y6o21jCvd0bmJjmqUSPB5On1YUhWepTveAKewMewLPMMTVmvsrKbG', 'mimi', 'teacher', 'fotos/profile/default.png');
